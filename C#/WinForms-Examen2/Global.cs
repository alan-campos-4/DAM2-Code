...
namespace WinForms_Examen2
{
    internal class Global
    {
        ...
        {
            return "Server=docarmo.net;Database=examen;User ID=examen;Password=examen;SslMode=none";
        }

        public string AddTitle = "Añadir Artículo";
        public string ModTitle = "Modificar Artículo";

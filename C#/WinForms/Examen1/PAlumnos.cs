...
namespace WinForms_Examen1
{
    public partial class PAlumnos : Form
    {
        ...
        public string GetStudentAverage(string n1, string n2, string n3)
        {
            double num = Double.Parse(n1) + Double.Parse(n2) + Double.Parse(n3);
        ...
        public void GetTotalAverage()
        {
            ...
            foreach (DataGridViewRow row in dataGridView1.Rows)
            {
                ...
                sum += Double.Parse(notas[0]) 
                    + Double.Parse(notas[1].Replace(" ", "")) 
                    + Double.Parse(notas[2].Replace(" ", ""));
                total += 3;
            }

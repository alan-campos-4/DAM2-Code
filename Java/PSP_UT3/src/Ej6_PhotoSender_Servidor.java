...
/***** EJERCICIO 6: ansmisión de Archivos Pequeños “Photo Sender” *****
Objetivo:
...
cliente. El cliente solicita un nombre de archivo, y el servidor lo envía en modo binario.
	...
	4. Pistas Teóricas:
		...
		o Recepción en el cliente y guardado:
			...
			...
		o Comprobar la existencia del archivo en el servidor (new
			File(nombreArchivo).exists()).
 */

public class Ej6_PhotoSender_Servidor
{

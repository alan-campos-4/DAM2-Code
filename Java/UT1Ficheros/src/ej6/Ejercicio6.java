 ...
 * Crear la clase Cotización con los métodos: GrabarCotización (se hará desde la URL), 
 * LeerCotización (se mostrará todo el contenido del fichero) y VerCotización(día,hora). 
